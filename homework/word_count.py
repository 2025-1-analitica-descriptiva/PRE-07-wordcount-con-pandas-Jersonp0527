...
def clean_text(dataframe):
    """Text cleaning"""
    #
    # Limpie el texto eliminando caracteres especiales y convirtiendo a minúsculas.
    # Almacene el resultado en una nueva columna llamada 'cleaned'.
    #
...
def dataframe_words(dataframe):
    """Word count"""
    #
    # Cuente la cantidad de palabras en cada línea y almacene el resultado en
    # una nueva columna llamada 'word_count'.
    #
    dataframe = dataframe.copy()
...
def run_job(input_directory, output_directory):
    ...
    dataframe = dataframe_words(dataframe)
